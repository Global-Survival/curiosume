...
- Swapsites for baby goods and toys
( toyswap , thredyp , swapitbaby , tauschteddy )

- Clothing Swaps
( swapstyme , the clothing exchange , 99 dresses , poshmark  )

- Swap sites for media ( dvd's , books , games )
( swap , dig n'swap , netcycler , swapsity )
...
- Car Sharing ( big automobile brands )
( bwn drivenow , volkswagen quicqr , Peugeot MU , Daimler Car2Go )
...
- Solarpower
( Solarcity , Solar Century , Pretasol , One Block Off the Grid )
...
- Art Rental
( Art.sy , Artiscle , Turningart )

- Fashionrental
( Bag Borrow or Steal , Fashion Hier , Dress Vault , Rent the Runway )

- Movies
( Netflix , Quickflix , Lovefilm )

- General Online Rental
( Getable , Anyhire , Snapgoods , Neighborgoods , Dogvacay )

- Peer-to-Peer Rental
( Zilok , Rentoid , Ecomodo , Hire Things , Rentstuff )

- Neighborhood Rental
( Share Some Sugar , Neighbor Row , The Sharehood , Frents )


 Collaborative Lifestyles

- Storage Networks
( Storepod , Sharemystorage , Spaceout

- Social Food Networks
( Gobble , Grubwithus , Eatwithme , wok+wine )
...
- Parkingspots
( Parkatmyhouse , Parkmcirca , Parkonmydrive )

- Sharedstudios / Workshops
...
- Gardens
( Urbangardenshare , landshare , yardshare )


- Crowdfunding
( Startsomegood , Pozible , Crowdcube , Catarse )

- Bartering
( Ourgoods , Itex , Bartercard , Tourboarding )

- Taxi Sharing
( Taxi2 , Taxistop , Weeels )

- Peer-to-Peer Travel
( Airbnb , Roomoroama , One Fine Stay , Bed and Fed , 9 Flats )

- Social Currencies
( Ven , The Liquidity Network , Time Banks , Letsystems )

- Social Lending
( Zopa , Prosper , The Lending Club )

- Co-working Space Finders
( desknearme , deskwanted , opendesks , desksurfing )

- Co-working Spaces
( networkcity , studiomates , beesoffice , coloft )
