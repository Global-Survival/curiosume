function renderTimeline(s, o, v) {
    var ae = uuid();
    var a = $('<div id="axis" style="width: 100%; height: 60px; background-color: black">');
    a.attr('id', ae);
    a.appendTo(v);
    
    var ee = uuid();
    $('<div style="width: 100%; height: 100%; background-image:url(/lib/chronozoom/Images/Blueprint_Paper.jpg); width: 100%; height: 100%;"/>').attr('id', ee).appendTo(v);
    
    initCZ(function() {
		
		var path = '/demo/enformable/enformable-fukushima-timeline.json';
		$.getJSON(path, function(data) {
			graphCZ(ae, ee, function(root) {							
